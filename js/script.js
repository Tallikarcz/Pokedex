...
const renderPokemon = async (pokemon) => {
  ...
  if (data) {
    ...
    pokemonImage.src = data["sprites"]["versions"]["generation-v"]["black-white"]["animated"]["front_default"] || data["sprites"]["front_default"]; // SI NO TIENE SPRITE ANIMADO, APARECE SPRITE ESTATICO
